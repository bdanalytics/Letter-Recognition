...
title: "UCI ML Repo::Letter Recognition: letter classification"
author: "bdanalytics"
...
setwd("~/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Assignments/HW4_Letter_Recognition")
```
...
## Step ``r glb_script_df[nrow(glb_script_df), "chunk_step_major"]``: fit models
```{r fit.models_1, cache=FALSE, fig.height=7.5}
